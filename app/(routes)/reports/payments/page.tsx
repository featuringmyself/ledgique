      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-indigo-50 p-4 sm:p-6 rounded-3xl border border-purple-100/50">
            <h3 className="text-gray-600 text-sm font-medium mb-3">Pending</h3>
            <p className="text-2xl sm:text-4xl font-bold text-gray-900">
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-4 sm:p-6 rounded-3xl border border-green-100/50">
            <h3 className="text-gray-600 text-sm font-medium mb-3">Total Payments</h3>
            <p className="text-2xl sm:text-4xl font-bold text-gray-900">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-amber-50 p-4 sm:p-6 rounded-3xl border border-orange-100/50">
            <h3 className="text-gray-600 text-sm font-medium mb-3">Avg Payment</h3>
            <p className="text-2xl sm:text-4xl font-bold text-gray-900">
              {formatCurrency(reportData.summary.averagePayment)}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 dark:bg-neutral-800 dark:border-neutral-700">
            ...
            <div className="mt-4 space-y-2">
              {reportData.methodBreakdown.map((item, idx) => (
                <div key={`method-${item.method}-${idx}`} className="flex items-center justify-between text-sm">
                  <span className="text-gray-600 dark:text-gray-400">
                    {item.method.replace(/_/g, ' ')}
                  </span>
                  <span className="font-medium text-gray-900 dark:text-white">
                    {item.percentage.toFixed(1)}% ({item.count} payments)
                  </span>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 dark:bg-neutral-800 dark:border-neutral-700">
            ...
            <div className="space-y-3">
              {reportData.topClients.map((client, index) => (
                <div key={client.clientId} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg dark:bg-neutral-700">
