...
export const MobileSidebar = ({
  ...
  return (
    <>
      {/* Mobile header bar - only shows hamburger menu */}
      <div
        className={cn(
          "fixed top-0 left-0 right-0 h-12 px-4 flex md:hidden items-center justify-between bg-neutral-100 dark:bg-neutral-800 z-40"
        )}
        {...props}
      >
